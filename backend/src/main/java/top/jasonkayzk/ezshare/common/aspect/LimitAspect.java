...
import top.jasonkayzk.ezshare.common.annotation.Limit;
...
public class LimitAspect {
    ...
    private final StringRedisTemplate limitRedisTemplate;

    public LimitAspect(StringRedisTemplate limitRedisTemplate) {
        this.limitRedisTemplate = limitRedisTemplate;
    }

    @Pointcut("@annotation(top.jasonkayzk.ezshare.common.annotation.Limit)")

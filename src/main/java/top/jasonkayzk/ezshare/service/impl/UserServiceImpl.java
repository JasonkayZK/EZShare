...
import static top.jasonkayzk.ezshare.EZShareApplication.settings;
...
public class UserServiceImpl implements IUserService {
    ...
    public User login(String loginName, String password, String token, HttpServletResponse response) {
        ...
        User user = null;
        if (allowLogin) {
            if (Checker.isNotEmpty(token) && EZShareApplication.tokens.containsKey(token)) {
                user = userDAO.getUserById(EZShareApplication.tokens.get(token));

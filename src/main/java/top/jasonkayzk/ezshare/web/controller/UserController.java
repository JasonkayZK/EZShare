...
import top.jasonkayzk.ezshare.util.ControllerUtils;
...
public class UserController {
    ...
    public String updateBasicInfo(String avatar, String realName, String email, String code) {
        ...
        boolean emilVerify = EZShareApplication.settings.getBooleanUseEval(ConfigConsts.EMAIL_VERIFY_OF_SETTINGS);

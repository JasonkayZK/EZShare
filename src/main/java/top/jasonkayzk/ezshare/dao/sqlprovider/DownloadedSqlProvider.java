...
public class DownloadedSqlProvider {
    ...
    public String getDownloadBy(@Param("userId") int userId, @Param("fileId") long fileId, @Param("fileName") String
        ...
        String sql = new SQL() {{
            ...
            ORDER_BY("d." + EZShareApplication.settings.getStringUseEval(ConfigConsts.DOWNLOAD_ORDER_BY_OF_SETTINGS));
        }}.toString();
        int size = EZShareApplication.settings.getIntegerUseEval(ConfigConsts.DOWNLOAD_PAGE_SIZE_OF_SETTINGS);

...
public class AuthSqlProvider {
    ...
    public String getAuthBy(@Param("id") long id, @Param("userId") int userId, @Param("fileId") long fileId, @Param
        ...
        String sql = new SQL() {{
            ...
            ORDER_BY("a." + EZShareApplication.settings.getStringUseEval(ConfigConsts.AUTH_ORDER_BY_OF_SETTINGS));
        }}.toString();
        int size = EZShareApplication.settings.getIntegerUseEval(ConfigConsts.AUTH_PAGE_SIZE_OF_SETTINGS);
